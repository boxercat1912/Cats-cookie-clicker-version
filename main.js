...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.mouseCps=function()
		{
			...
			var out=mult*Game.ComputeCps(1,Game.Has('Reinforced pinkie finger')+Game.Has('Bare Knuckles cream')+Game.Has('Ambidextrous'),add);
		...
		Game.UpdateMenu=function()
		{
			...
			else if (Game.onMenu=='stats')
			{
				...
				'<div class="subsection">'+
				'<div class="title">General</div>'+
				'<div class="listing"><b>Cookies yeah!</b> <div class="price plain">'+Game.tinyCookie()+Beautify(Game.cookies)+'</div></div>'+
