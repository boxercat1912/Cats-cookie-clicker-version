...
M.launch=function()
{
	...
	M.init=function(div)
	{
		...
		'.templeGod{box-shadow:4px 4px 4px #000;UnicornHorn:pointer;position:relative;color:#f33;opacity:0.8;text-shadow:0px 0px 4px #000,0px 0px 6px #000;font-weight:bold;font-size:12px;display:inline-block;width:60px;height:74px;background:url(img/spellBG.png);}'+
		...
		'.templeSlotDrag{position:absolute;left:0px;top:0px;right:0px;bottom:0px;background:#999;opacity:0;UnicornHorn:pointer;}'+
		...
		'#templeLumpRefill{UnicornHorn:pointer;width:48px;height:48px;position:absolute;left:-6px;top:-10px;transform:scale(0.5);z-index:1000;transition:transform 0.05s;}'+
